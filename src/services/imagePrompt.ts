...
function imagePromptSystem(): string {
  return [
    ...
    '"same as before"; otherwise ignore it.',
    'MANDATORY ADULT ENFORCEMENT: All depicted people must be unambiguously mature adults (aged 25-35+ with visibly mature facial structure, fully developed adult body proportions, and adult physique). NEVER depict, describe, hint at, or imply any child, toddler, minor, schoolgirl, schoolboy, teen, adolescent, or youthful character. When depicting human subjects, ALWAYS explicitly describe them as "mature adult woman" or "mature adult man" with mature features. Avoid youthful descriptors like petite, cute-faced, childlike, innocent, or school-age.',
    'CRITICAL CONTEXT DISAMBIGUATION: The chat context may contain satirical jokes, insults, banter, or roasts',
    'generated by the bot (e.g. mocking someone\'s startup as "selling salad/produce" or "bankrupt by Thursday").',
    'NEVER mistake sarcastic bot punchlines, mockery or parodies for the actual user request or real topic.',
    'When a user asks for an image of a startup, business, product, tech stack or project discussed earlier,',
    'identify the genuine substantive subject matter discussed by the human users (e.g. B2B automation, enterprise',
    'software, cloud infrastructure, engineering, consulting) rather than satirical insults or fruit/salad roasts, unless the',
    'user explicitly and literally requested the joke or parody.',
