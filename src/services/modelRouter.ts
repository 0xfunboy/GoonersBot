...
const BUILTIN_LEXICON = [
  ...
  'sexual',
  'sexy',
  // Italian/Spanish adult conversation: smart mode should follow an openly sexual discussion
  // without forcing it back through the more sanitized default model.
  'sesso',
  'sessual',
  'sexo',
  'eccit',
