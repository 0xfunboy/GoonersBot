...
export const translations: TranslationMap = {
  ...
  autoengage_description: {
    italian: 'Attiva/disattiva le risposte passive',
    english: 'Toggle passive replies for this chat',
    russian: 'Включить/выключить пассивные ответы',
    spanish: 'Activa/desactiva las respuestas pasivas',
  },
  vision_description: {
  ...
  news_description: {
    italian: 'Pubblica subito una news corrente con fonte',
    english: 'Post a current news item with its source now',
    russian: 'Опубликовать актуальную новость с источником',
    spanish: 'Publica ahora una noticia actual con su fuente',
  },
  genera_description: {
    italian: "Genera un'immagine originale dal prompt",
    english: 'Generate an original image from a prompt',
    russian: 'Создать оригинальное изображение по описанию',
    spanish: 'Genera una imagen original a partir de un prompt',
  },
  disegna_description: {
    italian: 'Genera un’illustrazione con profilo manga',
    english: 'Generate an illustration with the manga profile',
    russian: 'Создать иллюстрацию в манга-профиле',
    spanish: 'Genera una ilustración con perfil manga',
  },
  ban_description: {
  ...
  help_description: {
    italian: 'Guida completa dei comandi (IT/EN/ES)',
    english: 'Complete command reference (IT/EN/ES)',
  ...
  follow_description: {
    italian: 'Avvisi quando un nuovo episodio è disponibile',
    english: 'Get told when a new episode becomes available',
    russian: 'Уведомления о доступности новых серий',
    spanish: 'Avisos cuando haya un nuevo episodio disponible',
  },
  unfollow_description: {
    italian: 'Smetti di seguire',
    english: 'Stop following',
    russian: 'Перестать следить за сериалом',
    spanish: 'Deja de seguir',
  },
  following_description: {
    italian: 'Serie seguite qui',
    english: 'Series followed here',
    russian: 'Отслеживаемые сериалы',
    spanish: 'Series seguidas aquí',
  },
  anime_description: {
    italian: 'Uscite di un anime',
    english: 'Anime release status',
    russian: 'Статус выхода аниме',
    spanish: 'Estado de estreno',
  },
  follow_usage: {
    italian: 'Uso: <code>/follow &lt;titolo&gt;</code> — es. <code>/follow Chainsmoker Cat</code>',
    english:
      'Usage: <code>/follow &lt;title&gt;</code> — e.g. <code>/follow Chainsmoker Cat</code>',
    russian: 'Использование: <code>/follow &lt;название&gt;</code>',
    spanish: 'Uso: <code>/follow &lt;título&gt;</code>',
  },
  unfollow_usage: {
    italian: 'Uso: <code>/unfollow &lt;titolo&gt;</code>',
    english: 'Usage: <code>/unfollow &lt;title&gt;</code>',
    russian: 'Использование: <code>/unfollow &lt;название&gt;</code>',
    spanish: 'Uso: <code>/unfollow &lt;título&gt;</code>',
  },
  anime_usage: {
    italian: 'Uso: <code>/anime &lt;titolo&gt;</code>',
    english: 'Usage: <code>/anime &lt;title&gt;</code>',
    russian: 'Использование: <code>/anime &lt;название&gt;</code>',
    spanish: 'Uso: <code>/anime &lt;título&gt;</code>',
  },
  anime_disabled: {
    italian: 'Il catalogo anime non è attivo su questa istanza.',
    english: 'The anime catalog is not enabled on this instance.',
    russian: 'Каталог аниме не включён в этой инсталляции.',
    spanish: 'El catálogo de anime no está activo en esta instancia.',
  },
  follow_created: {
    italian: '✅ Seguo <b>{series}</b>. Vi avviso qui quando esce un episodio nuovo.',
    english: '✅ Following <b>{series}</b>. I will post here when a new episode airs.',
    russian: '✅ Слежу за <b>{series}</b>. Сообщу здесь о новой серии.',
    spanish: '✅ Siguiendo <b>{series}</b>. Aviso aquí cuando salga un episodio nuevo.',
  },
  follow_already: {
    italian: 'Già seguita: <b>{series}</b>. Niente doppioni.',
    english: 'Already following <b>{series}</b>. No duplicate created.',
    russian: 'Уже слежу за <b>{series}</b>.',
    spanish: 'Ya la sigo: <b>{series}</b>.',
  },
  follow_ambiguous: {
    italian:
      'Più serie corrispondono a "<b>{title}</b>". Ripeti con il titolo esatto:\n{candidates}',
    english: 'Several series match "<b>{title}</b>". Repeat with the exact title:\n{candidates}',
    russian: 'Несколько сериалов подходят под "<b>{title}</b>":\n{candidates}',
    spanish: 'Varias series coinciden con "<b>{title}</b>":\n{candidates}',
  },
  follow_not_found: {
    italian: 'Nessuna serie trovata per "<b>{title}</b>".',
    english: 'No series found for "<b>{title}</b>".',
    russian: 'Сериал "<b>{title}</b>" не найден.',
    spanish: 'No encuentro ninguna serie para "<b>{title}</b>".',
  },
  follow_limit: {
    italian: 'Questa chat ha raggiunto il limite di serie seguite.',
    english: 'This chat has reached its follow limit.',
    russian: 'Достигнут лимит отслеживаемых сериалов.',
    spanish: 'Este chat alcanzó el límite de series seguidas.',
  },
  unfollow_done: {
    italian: 'Smesso di seguire <b>{series}</b>.',
    english: 'Stopped following <b>{series}</b>.',
    russian: 'Больше не слежу за <b>{series}</b>.',
    spanish: 'Dejé de seguir <b>{series}</b>.',
  },
  unfollow_not_following: {
    italian: 'Questa chat non seguiva "<b>{title}</b>".',
    english: 'This chat was not following "<b>{title}</b>".',
    russian: 'Этот чат не следил за "<b>{title}</b>".',
    spanish: 'Este chat no seguía "<b>{title}</b>".',
  },
  following_empty: {
    italian: 'Questa chat non segue nessuna serie. Usa <code>/follow &lt;titolo&gt;</code>.',
    english: 'This chat follows no series yet. Use <code>/follow &lt;title&gt;</code>.',
    russian: 'Этот чат пока ни за чем не следит. <code>/follow &lt;название&gt;</code>',
    spanish: 'Este chat no sigue ninguna serie. Usa <code>/follow &lt;título&gt;</code>.',
  },
  following_list: {
    italian: '<b>Serie seguite ({count})</b>\n{series}',
    english: '<b>Followed series ({count})</b>\n{series}',
    russian: '<b>Отслеживаемые сериалы ({count})</b>\n{series}',
    spanish: '<b>Series seguidas ({count})</b>\n{series}',
  },
  anime_not_found: {
    italian: 'Non trovo "<b>{title}</b>" nel catalogo.',
    english: 'I cannot find "<b>{title}</b>" in the catalog.',
    russian: 'Не нахожу "<b>{title}</b>" в каталоге.',
    spanish: 'No encuentro "<b>{title}</b>" en el catálogo.',
  },
  learn_description: {
    ...
    russian: 'Исследовать или разработать проверяемую возможность (админ бота)',
    spanish: 'Investiga o desarrolla una capacidad revisable (admin del bot)',
  },
  ...
  profile_report: {
    italian:
      '{title}: {plan}\nConversazioni: {conversations_day}/{conversations_limit} oggi ({conversations_remaining} rimaste), {conversations_hour}/{conversations_hour_limit} ora ({conversations_hour_remaining} rimaste)\nToken LLM: {tokens}/{tokens_limit} oggi ({tokens_remaining} rimasti)\nWeb: {web}/{web_limit} ({web_remaining} rimaste) | pagine: {pages}/{pages_limit} ({pages_remaining} rimaste)\nNews: {news}/{news_limit} ({news_remaining} rimaste) | immagini: {images}/{images_limit} ({images_remaining} rimaste)\nMedia: {media}/{media_limit} ({media_remaining} rimasti), {media_mb}/{media_mb_limit} ({media_mb_remaining})\nPassive: {passive}/{passive_limit} ora ({passive_remaining} rimaste)\nAnti-flood: utente {user_burst}/min, chat {chat_burst}/min',
    english:
      '{title}: {plan}\nConversations: {conversations_day}/{conversations_limit} today ({conversations_remaining} left), {conversations_hour}/{conversations_hour_limit} this hour ({conversations_hour_remaining} left)\nLLM tokens: {tokens}/{tokens_limit} today ({tokens_remaining} left)\nWeb: {web}/{web_limit} ({web_remaining} left) | pages: {pages}/{pages_limit} ({pages_remaining} left)\nNews: {news}/{news_limit} ({news_remaining} left) | images: {images}/{images_limit} ({images_remaining} left)\nMedia: {media}/{media_limit} ({media_remaining} left), {media_mb}/{media_mb_limit} ({media_mb_remaining})\nPassive: {passive}/{passive_limit} this hour ({passive_remaining} left)\nAnti-flood: user {user_burst}/min, chat {chat_burst}/min',
    russian:
      '{title}: {plan}\nДиалоги: {conversations_day}/{conversations_limit} сегодня (осталось {conversations_remaining}), {conversations_hour}/{conversations_hour_limit} за час (осталось {conversations_hour_remaining})\nТокены LLM: {tokens}/{tokens_limit} сегодня (осталось {tokens_remaining})\nWeb: {web}/{web_limit} (осталось {web_remaining}) | страницы: {pages}/{pages_limit} (осталось {pages_remaining})\nНовости: {news}/{news_limit} (осталось {news_remaining}) | изображения: {images}/{images_limit} (осталось {images_remaining})\nМедиа: {media}/{media_limit} (осталось {media_remaining}), {media_mb}/{media_mb_limit} ({media_mb_remaining})\nПассивно: {passive}/{passive_limit} за час (осталось {passive_remaining})\nАнтифлуд: пользователь {user_burst}/мин, чат {chat_burst}/мин',
    spanish:
      '{title}: {plan}\nConversaciones: {conversations_day}/{conversations_limit} hoy ({conversations_remaining} restantes), {conversations_hour}/{conversations_hour_limit} esta hora ({conversations_hour_remaining} restantes)\nTokens LLM: {tokens}/{tokens_limit} hoy ({tokens_remaining} restantes)\nWeb: {web}/{web_limit} ({web_remaining} restantes) | páginas: {pages}/{pages_limit} ({pages_remaining} restantes)\nNoticias: {news}/{news_limit} ({news_remaining} restantes) | imágenes: {images}/{images_limit} ({images_remaining} restantes)\nMedia: {media}/{media_limit} ({media_remaining} restantes), {media_mb}/{media_mb_limit} ({media_mb_remaining})\nPasivas: {passive}/{passive_limit} esta hora ({passive_remaining} restantes)\nAntiflood: usuario {user_burst}/min, chat {chat_burst}/min',
  },
