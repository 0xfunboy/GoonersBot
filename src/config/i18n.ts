...
export const translations: TranslationMap = {
  ...
  follow_description: {
    italian: 'Avvisi sui nuovi episodi',
    english: 'Get told when a new episode airs',
    russian: 'Уведомления о новых сериях',
    spanish: 'Avisos de nuevos episodios',
  },
  ...
  help_text: {
    italian: [
      ...
      '• <em>/anime &lt;titolo&gt;</em> - uscite e prossimo episodio; la disponibilità AnimeUnity/HentaiSaturn passa dall’azione archivio',
      '• <em>/follow</em> · <em>/unfollow</em> · <em>/following</em> (alias /segui, /seguite) - avvisi sui nuovi episodi',
      '• <em>/help</em> - questo',
      '',
    ...
    english: [
      ...
      '• <em>/anime &lt;title&gt;</em> - release status and next episode; AnimeUnity/HentaiSaturn availability is handled by the archive action',
      '• <em>/follow</em> · <em>/unfollow</em> · <em>/following</em> - new-episode alerts for this chat',
      '• <em>/help</em> - this',
      '',
    ...
    russian: [
      ...
      '• <em>/anime &lt;название&gt;</em> - статус выхода и где смотреть',
      '• <em>/follow &lt;название&gt;</em> - уведомлять о новых сериях',
      '• <em>/unfollow &lt;название&gt;</em> - перестать следить',
      '• <em>/following</em> - отслеживаемые сериалы',
      '• <em>/help</em> - это',
      '',
    ...
    spanish: [
      ...
      '• <em>/anime &lt;título&gt;</em> - estado de estreno; la disponibilidad en AnimeUnity/HentaiSaturn usa la acción de archivo',
      '• <em>/follow &lt;título&gt;</em> - avisar aquí cuando salga un episodio',
      '• <em>/unfollow &lt;título&gt;</em> - dejar de seguirla',
      '• <em>/following</em> - series que sigue este chat',
      '• <em>/help</em> - esto',
      '',
