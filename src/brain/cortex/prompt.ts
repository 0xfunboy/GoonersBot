...
export const CORTEX_SYSTEM = [
  ...
  '- anime_knowledge: LIVE anime release data and this chat\'s series follows. Use it for "e uscito',
...
export const CORTEX_FEWSHOT = [
  ...
  'DECISION: {"intents":["answer"],"toolCalls":[{"tool":"anime_knowledge","query":"Tanya the Evil","args":{"intent":"lookup","title":"Tanya the Evil"},"reason":"live release status must come from the catalog"}],"valueTarget":"truth","roastBudget":"light","socialRole":"truth_checker","needsGrounding":true,"confidence":0.93,"reason":"anime release question, deterministic catalog lookup"}',
  '',
  'MESSAGE (it): "quando esce il prossimo episodio di Chainsmoker Cat e dove lo posso vedere?"',
  'DECISION: {"intents":["answer"],"toolCalls":[{"tool":"anime_knowledge","query":"Chainsmoker Cat","args":{"intent":"lookup","title":"Chainsmoker Cat"},"reason":"named series: the catalog has the schedule and the official streaming links"}],"valueTarget":"truth","roastBudget":"light","socialRole":"truth_checker","needsGrounding":true,"confidence":0.94,"reason":"release date and where to watch both come from the catalog"}',
  '',
