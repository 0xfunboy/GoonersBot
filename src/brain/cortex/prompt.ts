...
export const CORTEX_SYSTEM = [
  ...
  '  news, or any factual claim needing verification.',
  ...
  '- image_gen: user wants an image/meme/drawing generated (manga style -> intent draw_image).',
  '- translate / tts / music: when the user wants a translation / voice note / a song from YouTube.',
